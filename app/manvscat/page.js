...
export default function ManVsCat() {
  ...
  useEffect(() => {
    ...
    function updateParallax(angle) {
      ...
      if (clock)
        clock.style.transform = `translateX(${
          Math.sin(rad * 1.5) * depth - 40
        }px) scale(1.05)`;
    }
  ...
  return (
    <main className="bg-black text-white w-screen h-screen overflow-hidden select-none flex items-center justify-center">
      {/* === Единый макет (1920x1080) === */}
      <div
        id="pc-layout"
